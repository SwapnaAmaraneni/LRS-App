...
import 'package:lrsofficer/repository/phase2_reverted_repo/phase2_reverted_applications_repo.dart';
...
class Phase2RevertedLayoutApplicationDetailsViewModel with ChangeNotifier {
    ...
    try {
      if (await internetCheck()) {
        ...
        SavedApplicationDetailsResponse? response =
            await Phase2RevertedApplDetailsRepository()
                .phase2RevertedApplDetailsRepo(context, request);
...
/*       await prefs.setString(SharedPrefConstants.plotNoKey, plotNo);
      ...
      if (AppConstants.isLayoutPlot == "L" &&
        ...
        Navigator.pushNamed(context, AppRoutes.phase2RevertedAddUnsoldPlots);
        ...
        Navigator.pushNamed(context, AppRoutes.phase2RevertedUploadPlotDetails);
      }
    }
  }
    ...
    if (otpText.isEmpty || otpText.length < 4) {
      ...
      SuccessCustomCupertinoAlert().showAlert(
          ...
          onPressed: () async {
            ...
            await updateMobileProvider.updatePhase2RevertedMobileApi(
              context,
