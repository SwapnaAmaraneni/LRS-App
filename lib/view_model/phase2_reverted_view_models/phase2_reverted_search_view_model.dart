...
import 'package:lrsofficer/repository/phase2_reverted_repo/phase2_reverted_search_repo.dart';
...
class Phase2RevertedSearchViewModel with ChangeNotifier {
  final serachRepo = Phase2RevertedSearchApplicationRepository();
      ...
      if (await internetCheck()) {
        ...
        if (response != null && response.statusCode == ApiErrorCodes.success) {
          ...
          if (applicationsCount.isNotEmpty) {
            ...
            key.clear();
            Navigator.pushNamed(
                context, AppRoutes.phase2RevertedSearchedApplicationList);
          }
