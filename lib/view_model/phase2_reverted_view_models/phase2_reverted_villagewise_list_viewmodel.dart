...
class Phase2RevertedVillagewiseListViewModel extends ChangeNotifier {
  ...
  Future<void> getClusterWiseVillageCount(BuildContext context) async {
    try {
      applications.clear();
      if (await internetCheck()) {
        ...
        VillageWiseSurveyNumbersResponse? response =
            await Phase2RevertedVillagewiseListRepository()
                .getVillagewiseList(context, request);
