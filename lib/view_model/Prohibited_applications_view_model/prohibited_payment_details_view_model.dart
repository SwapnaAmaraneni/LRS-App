...
class ProhibitedPaymentDetailsViewModel extends ChangeNotifier {
  ...
  void setMvText(String text) {
    mvText = text;
    notifyListeners();
  }

  void setMvDateOfRegstnText(String text) {
    mvDateOfRegstnText = text;
    notifyListeners();
  }

  void setMvEditable(bool editable) {
    mvEditable = editable;
    notifyListeners();
  }
