...
import 'package:lrsofficer/repository/prohibited_final_submit_repo.dart';
...
class ProhibitedRecommendationsModel with ChangeNotifier {
       ...
       */
              ...
              if (connection) {
                ...
                if (AppConstants.isSavedApplication == "yes") {
                  submitResponse = await ProhibitedFinalSubmitRepository()
...
/*       String? latitude = prefs.getString(SharedPrefConstants.latitudeKey);
  ...
  void clearSavedData(BuildContext context) {
    // Clear ViewModel Persistent States
    Provider.of<ProhibitedApplicationDetailsViewModel>(context, listen: false).clearAll();
    Provider.of<ProhibitedUploadPlotDetailsViewModel>(context, listen: false).clearAll();
    Provider.of<ProhibitedCheckDetailsViewModel>(context, listen: false).clearAll();
    Provider.of<ProhibitedPaymentDetailsViewModel>(context, listen: false).clearAll();
    Provider.of<ProhibitedLayoutApplicationDetailsViewModel>(context, listen: false).clearAll();
    Provider.of<AddCoordinatesViewModel>(context, listen: false).clearAll();
    clearAll(); // from this view model
