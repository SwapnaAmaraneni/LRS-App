...
class ProhibitedUploadPlotDetailsViewModel with ChangeNotifier {
  ...
  List<String> imagesString = List.generate(4, (_) => "");
  bool isInitialized = false;

  void setLayoutSelectedAnswer(String? answer) {
    layoutSelectedAnswer = answer ?? "";
    notifyListeners();
  }

  void setLayoutSelectedDoc(String? path) {
    layoutSelectedDoc = path;
    notifyListeners();
  }

  void setOwnershipDocSelectedAnswer(String? answer) {
    ownershipDocSelectedAnswer = answer ?? "";
    notifyListeners();
  }

  void setOwnershipSelectedDoc(String? path) {
    ownershipSelectedDoc = path;
    notifyListeners();
  }

  void setEcDocSelectedAnswer(String? answer) {
    ecDocSelectedAnswer = answer ?? "";
    notifyListeners();
  }

  void setEcSelectedDoc(String? path) {
    ecSelectedDoc = path;
    notifyListeners();
  }

  void setImage(int index, String path) {
    imagesString[index] = path;
    notifyListeners();
  }
  ...
  void clearAll() {
    ...
    imagesString = List.generate(4, (_) => "");
    isInitialized = false;
    notifyListeners();
  }
  ...
  Future<void> validationsForPlotDetails(
    ...
    // Save document answers and selected docs
    await prefs.setString(
    ...
    Navigator.pushNamed(context, AppRoutes.prohibitedAddCoordinates);
  }
