...
import '../../models/saved_applications/saved_application_details_response.dart' hide CHECKLIST;

class ProhibitedCheckDetailsViewModel with ChangeNotifier {
  ...
  void clearAll() {
    ...
    dROPDOWNs.clear();
    checkList.clear();
    for (var c in remarksControllers) {
      c.dispose();
    }
  ...
  Future<void> submit(BuildContext context) async {
    ...
    userType.toString().toLowerCase() == "tp"
        ...
        : Navigator.pushNamed(context, AppRoutes.prohibitedRecommendations);
    // }
  }
  ...
  Future<void> checkDetailsViewModel(BuildContext context) async {
    // Skip re-fetching if already loaded — preserves answers on back-navigation
    ...
    try {
      if (await internetCheck()) {
        ...
        // Do NOT clear responses here — user answers must survive
