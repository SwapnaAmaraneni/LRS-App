...
class ShortfallPaymentDetailsViewModel extends ChangeNotifier {
  ...
  // Safe getter for first cluster detail
  ...
  Future<void> navigateToRecommendations(
    ...
    Navigator.pushNamed(context, AppRoutes.shortfallRecommendations);
  }
}
