...
import 'package:lrsofficer/repository/shortfall_applicatuions_repo/shortfall_search_repo.dart';
...
class ShortfallSearchViewModel with ChangeNotifier {
  final serachRepo = ShortfallSearchApplicationRepository();
        ...
        if (await internetCheck()) {
          ...
          if (response != null &&
            ...
            if (applicationsCount.isNotEmpty) {
              ...
              if (!context.mounted) return;
              key.clear();
              Navigator.pushNamed(context, AppRoutes.shortfallSearchList);
            }
