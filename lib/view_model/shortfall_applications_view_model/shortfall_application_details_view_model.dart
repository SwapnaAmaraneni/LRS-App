...
class ShortfallApplicationDetailsViewModel extends ChangeNotifier {
  ...
  TextEditingController roadEffectedAreaExtentController = TextEditingController();
  ...
  TextEditingController totalNoOfLayoutPlotsController = TextEditingController();
  ...
  TextEditingController totalUnsoldLayoutPlotsAreaController = TextEditingController();
  ...
  TextEditingController mvAsonDateOfRegistraionController = TextEditingController();
  TextEditingController regularizationChargesController = TextEditingController();
  TextEditingController openSpaceChargesController = TextEditingController();
  TextEditingController totalRegularizationChargesController = TextEditingController();
  ...
  void clearAll() {
    ...
    totalUnsoldLayoutPlotsAreaController.clear();
    zdpController.clear();
    latitudeController.clear();
    longitudeController.clear();
    applicationNoController.clear();
    applicantNameController.clear();
    fatherOrSpouseNameController.clear();
    aadharNumberController.clear();
    genderController.clear();
    addressController.clear();
    houseNoController.clear();
    streetOrColonyController.clear();
    applicantLocalityController.clear();
    townController.clear();
    districtController.clear();
    pincodeController.clear();
    applicantMobileNoController.clear();
    emailIdController.clear();
    alternateMobileNoController.clear();
    totalPlotAreaController.clear();
    conversionChargesController.clear();
    mvAsOn26082020Controller.clear();
    mvAsonDateOfRegistraionController.clear();
    regularizationChargesController.clear();
    openSpaceChargesController.clear();
    totalRegularizationChargesController.clear();
    initialAmountPaidController.clear();
      ...
      if (await internetCheck()) {
        ...
        if (response != null && response.statusCode == ApiErrorCodes.success) {
          ...
          if (applicationsCount.isNotEmpty) {
            ...
            if (!kReleaseMode) {
              debugPrint(
                  "Officer_list_type:: ${response.clusterApplicationDetails?[0].officersComments.runtimeType}");
            }
          }
  ...
  Future<void> navigateToUploadDocsScreen(
    ...
    if (isSroEdited == true && sroCode.length != 4) {
      ...
      if (!context.mounted) return;
      Navigator.pushNamed(context, AppRoutes.shortfallUploadPlotDetails);
    }
  }
    ...
    if (otpText.isEmpty || otpText.length < 4) {
      ...
      SuccessCustomCupertinoAlert().showAlert(
          ...
          onPressed: () async {
            ...
            await updateMobileProvider.updateShortfallMobileApi(
              context,
  ...
  Future<void> revenueNavigation({
    ...
    if (!context.mounted) return;
    Navigator.pushNamed(context, AppRoutes.shortfallChecklist);
  }
}
