...
import 'package:lrsofficer/repository/shortfall_applicatuions_repo/shortfall_villagewise_list_repo.dart';
...
class ShortfallSurveyNowiseListViewModel extends ChangeNotifier {
    ...
    try {
      if (await internetCheck()) {
        ...
        ListofClusterCountResponse? response =
            await ShortfallVillagewiseListRepository()
