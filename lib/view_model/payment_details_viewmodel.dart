...
class PaymentDetailsViewmodel extends ChangeNotifier {
  ...
  clearAll() {
    conversionCharges.clear();
    mv.clear();
    mvDateOfRegstn.clear();
    totalAmount = '';
    chargesFlag = false;
    mvText = "";
    mvDateOfRegstnText = "";
    clusterCalulationDetails?.clear();
    notifyListeners();
  }
  ...
  // Getter for first calculation detail safely
  CalulationDetails? get firstClusterDetail => (clusterCalulationDetails != null && clusterCalulationDetails!.isNotEmpty) ? clusterCalulationDetails!.first : null;
  List<CalulationDetails>? get getClusterPayDetails => clusterCalulationDetails;
  bool chargesFlag1 = false;
  bool get getchargesFlag => chargesFlag1;
  void setchargesFlag(bool ischargesVisible) {
    chargesFlag1 = ischargesVisible;
    notifyListeners();
  }
