...
class UploadPlotDetailsViewModel with ChangeNotifier {
  ...
  Future<void> validationsForPlotDetails({
    ...
    await prefs.setString(
        SharedPrefConstants.ecDocumentRadioVal, ecDocSelectedAnswer.toString());
    ...
    if (!context.mounted) return;
    Navigator.pushNamed(context, AppRoutes.addCoordinates);
  }
