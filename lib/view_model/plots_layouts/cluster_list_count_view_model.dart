...
import 'package:lrsofficer/repository/list_of_cluster_count_repo.dart';
...
class SurveyNumberWiseClustersListViewModel extends ChangeNotifier {
    ...
    try {
      if (await internetCheck()) {
        ...
        ListofClusterCountResponse? response =
            await ListOfClusterCountRepository()
                .listOfclusterCountRepo(context, request);
