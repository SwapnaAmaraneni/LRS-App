...
import 'package:lrsofficer/repository/phase1_repo/phase1_villagewise_list_repo.dart';
...
class Phase1SurveyNowiseListViewModel extends ChangeNotifier {
    ...
    try {
      if (await internetCheck()) {
        ...
        ListofClusterCountResponse? response =
            await Phase1VillagewiseListRepository()
