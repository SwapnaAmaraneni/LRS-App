...
import 'package:lrsofficer/repository/phase1_repo/phase1_applications_repo.dart';
...
class Phase1ApplicationDetailsViewModel extends ChangeNotifier {
    ...
    try {
      if (await internetCheck()) {
        ...
        ClusterApplicationDetailsResponse? response =
            await Phase1ApplDetailsRepository()
                .phase1ApplDetailsRepo(context, request);
  ...
  Future<void> revenueNavigation({
    ...
    if (!context.mounted) return;
    Navigator.pushNamed(context, AppRoutes.phase1Checklist);
  }
}
