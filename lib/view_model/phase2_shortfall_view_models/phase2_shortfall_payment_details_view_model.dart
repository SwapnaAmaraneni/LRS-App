...
class Phase2ShortfallPaymentDetailsViewModel extends ChangeNotifier {
  ...
  Future<void> paymentDetalsCalc(String conversionCharges, String mVRATE2020,
    ...
    if (connection) {
      ...
      AppLogger()
          .logDebug("paymentDetailsPayload ${paymentDetailsPayload.toJson()}");
  ...
  Future<void> navigateToRecommendations(
    ...
    Navigator.pushNamed(context, AppRoutes.phase2ShortfallRecommendations);
  }
}
