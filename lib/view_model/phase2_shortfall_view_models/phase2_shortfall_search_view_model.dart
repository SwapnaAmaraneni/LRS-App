...
import 'package:lrsofficer/repository/phase2_shortfall_repo/phase2_shortfall_search_repo.dart';
...
class Phase2ShortfallSearchViewModel with ChangeNotifier {
  final serachRepo = Phase2ShortfallSearchApplicationRepository();
      ...
      if (await internetCheck()) {
        ...
        if (response != null && response.statusCode == ApiErrorCodes.success) {
          ...
          if (applicationsCount.isNotEmpty) {
            ...
            key.clear();
            Navigator.pushNamed(
                context, AppRoutes.phase2SearchedApplicationList);
          }
