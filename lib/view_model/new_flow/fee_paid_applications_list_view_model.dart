...
import 'package:lrsofficer/repository/new_flow/fee_paid_applications_list_repository.dart';
...
class FeePaidApplicationsListViewModel with ChangeNotifier {
    ...
    try {
      ...
      if (await internetCheck()) {
        ...
        FifpApplicationsListResponse? response =
            await FeePaidApplicationsListRepository()
                .feepaidApplicationApi(context, payload);
        if (response != null) {
