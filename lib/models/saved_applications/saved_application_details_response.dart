class SavedApplicationDetailsResponse {
  int? statusCode;
  String? statusMsg;
  List<ApplicationDetails>? applications;

  SavedApplicationDetailsResponse(
      {this.statusCode, this.statusMsg, this.applications});

  SavedApplicationDetailsResponse.fromJson(Map<String, dynamic> json) {
    statusCode = json['StatusCode'];
    statusMsg = json['StatusMsg'];
    if (json['applications'] != null) {
      applications = <ApplicationDetails>[];
      json['applications'].forEach((v) {
        applications!.add(ApplicationDetails.fromJson(v));
      });
    }
  }
...
class ApplicationDetails {
  ...
  String? iSLayoutPlot;
  String? totalNoPlots;
  String? totalNoSoldPlots;
  String? totalNoUnSoldPlots;
  String? totalNoAreaExtent;
  String? unSoldPlotsXML;
  ...
  String? l2Remarks;
  String? l3Remarks;
  List<ListUnsoldPlots>? listUnsoldPlots;
  ...
  ApplicationDetails(
      ...
      this.iSLayoutPlot,
      this.totalNoPlots,
      this.totalNoSoldPlots,
      this.totalNoUnSoldPlots,
  ...
  ApplicationDetails.fromJson(Map<String, dynamic> json) {
    ...
    totalNoSoldPlots = json['Total_No_Sold_Plots'];
    totalNoUnSoldPlots = json['Total_No_UnSold_Plots'];
    totalNoAreaExtent = json['Total_No_AreaExtent'];
    unSoldPlotsXML = json['UnSoldPlotsXML'];
    ...
    amountToBePaid = json['TO_BE_PAID_AMOUNT'];
    if (json['listUnsoldPlots'] != null) {
      listUnsoldPlots = <ListUnsoldPlots>[];
      json['listUnsoldPlots'].forEach((v) {
        listUnsoldPlots!.add(ListUnsoldPlots.fromJson(v));
      });
    }
    ...
    if (json['listSaveDatas'] != null) {
      listSaveDatas = <ListSaveData>[];
      json['listSaveDatas'].forEach((v) {
        listSaveDatas!.add(ListSaveData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['Total_No_Sold_Plots'] = totalNoSoldPlots;
    data['Total_No_UnSold_Plots'] = totalNoUnSoldPlots;
    data['Total_No_AreaExtent'] = totalNoAreaExtent;
    data['UnSoldPlotsXML'] = unSoldPlotsXML;
    ...
    data['TO_BE_PAID_AMOUNT'] = amountToBePaid;
    if (listUnsoldPlots != null) {
      data['listUnsoldPlots'] =
          listUnsoldPlots!.map((v) => v.toJson()).toList();
    }
    if (cHECKLIST != null) {
    ...
    if (listSaveDatas != null) {
      data['listSaveDatas'] = listSaveDatas!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class ListUnsoldPlots {
  String? plotNo;
  String? plotAreaExtent;

  ListUnsoldPlots({this.plotNo, this.plotAreaExtent});

  ListUnsoldPlots.fromJson(Map<String, dynamic> json) {
    plotNo = json['Plot_No'];
...
class CHECKLIST {
  ...
  CHECKLIST.fromJson(Map<String, dynamic> json) {
    ...
    sTATUSID = json['STATUS_ID'];
    docment = json['Docment'];
    checkDRopDown = json['CheckDRopDown'];
...
class ListSaveData {
  ...
  ListSaveData.fromJson(Map<String, dynamic> json) {
    ...
    /* Adding from map if saved in CheckList
        cHECKLISTID = json['CHECKLIST_ID'];
    sTATUSID = json['STATUS_ID'];
    docment = json['Docment'];
    checkDRopDown = json['CheckDRopDown'];
