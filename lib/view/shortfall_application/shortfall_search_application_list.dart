...
class SearchShortfallClusterwiseApplicationList extends StatefulWidget {
  const SearchShortfallClusterwiseApplicationList({super.key});

  @override
  State<SearchShortfallClusterwiseApplicationList> createState() =>
      _SearchShortfallClusterwiseApplicationListState();
}

class _SearchShortfallClusterwiseApplicationListState
    extends State<SearchShortfallClusterwiseApplicationList> {
  @override
  Widget build(BuildContext context) {
    final searchApplListProvider =
        Provider.of<ShortfallSearchViewModel>(context);
    return Stack(
      children: [
        Scaffold(
