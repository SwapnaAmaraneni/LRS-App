...
class ShortfallRecommendations extends StatefulWidget {
  const ShortfallRecommendations({super.key});

  @override
  State<ShortfallRecommendations> createState() =>
      _ShortfallRecommendationsState();
}

class _ShortfallRecommendationsState extends State<ShortfallRecommendations> {
  @override
  Widget build(BuildContext context) {
    if (!kReleaseMode) debugPrint("UserType:: ${AppConstants.userType}");
    final recommendationsProvider =
        Provider.of<ShortfallRecommendationsModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Shortfall Recommendations",
          ),
          body: SafeArea(
            child: Container(
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final recommendationsProvider =
          Provider.of<ShortfallRecommendationsModel>(context, listen: false);
      if (!recommendationsProvider.isInitialized) {
        ...
        recommendationsProvider.isInitialized = true;
      }
    });
  }
}
