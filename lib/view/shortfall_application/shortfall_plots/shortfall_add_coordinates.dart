...
class ShortfallAddCoordinates extends StatefulWidget {
  const ShortfallAddCoordinates({super.key});

  @override
  State<ShortfallAddCoordinates> createState() =>
      _ShortfallAddCoordinatesState();
}

class _ShortfallAddCoordinatesState extends State<ShortfallAddCoordinates> {
  @override
  Widget build(BuildContext context) {
    final addCoordinatesProvider =
        Provider.of<ShortfallAddCoordinatesViewModel>(context);
        ...
        Scaffold(
          appBar: AppBarReusable(
            title: AppConstants.isLayoutPlot == "L"
                ? "Shortfall Layout Coordinates"
                : "Shortfall Plot Coordinates",
          ),
          body: SafeArea(
            child: Stack(
  ...
  initState() {
    super.initState();
    final addCoordinatesProvider =
        Provider.of<ShortfallAddCoordinatesViewModel>(context, listen: false);
    if (!kReleaseMode) {
      debugPrint(
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (timeStamp) async {
        if (!addCoordinatesProvider.isInitialized) {
          addCoordinatesProvider.clearCoordinates();
          ...
          addCoordinatesProvider.isInitialized = true;
        }
      },
    );
  }
