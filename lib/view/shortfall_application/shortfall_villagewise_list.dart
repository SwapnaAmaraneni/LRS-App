...
class ShortfallVillagewiseList extends StatefulWidget {
  const ShortfallVillagewiseList({super.key});

  @override
  State<ShortfallVillagewiseList> createState() =>
      _ShortfallVillagewiseListState();
}

class _ShortfallVillagewiseListState extends State<ShortfallVillagewiseList> {
  @override
  Widget build(BuildContext context) {
    final shortfallVillagewiseListProvider =
        Provider.of<ShortfallVillagewiseListViewModel>(context);
    ...
    return Stack(
      children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: shortfallVillagewiseListProvider
                                .applications.isNotEmpty
                            ? ListView.builder(
                                itemBuilder: (context, index) {
                                  VillageWiseSurveyNumbers applicationsData =
                                      shortfallVillagewiseListProvider
                                          .applications[index];
                                  return GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(context,
                                          AppRoutes.shortfallSurveyNowiseList,
                                          arguments:
                                ...
                                itemCount: shortfallVillagewiseListProvider
                                    .applications.length,
                              )
                            : Container(),
                      )
        ...
        if (shortfallVillagewiseListProvider.getLoaderVisibilityStatus ||
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final shortfallVillagewiseListProvider =
          Provider.of<ShortfallVillagewiseListViewModel>(context,
              listen: false);
      await shortfallVillagewiseListProvider
