...
class Phase2ShortfallApplicationDetails extends StatefulWidget {
  const Phase2ShortfallApplicationDetails({super.key});

  @override
  State<Phase2ShortfallApplicationDetails> createState() =>
      _Phase2ShortfallApplicationDetailsState();
}

class _Phase2ShortfallApplicationDetailsState
    extends State<Phase2ShortfallApplicationDetails> {
  ...
  Widget build(BuildContext context) {
    final phase2ShortfallApplDetailsProvider =
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (!didPop) {
          phase2ShortfallApplDetailsProvider.clusterApplDetails.isNotEmpty
              ? WarningCustomCupertinoAlertTwoButtons().showAlert(
                  context,
                  message:
                      "Data of the Application ID : ${phase2ShortfallApplDetailsProvider.clusterApplDetails[0].aPPLICATIONID} will be lost. Do you want to continue? ",
                  onPressedOk: () {
      ...
      child: Stack(
        children: [
          Scaffold(
            appBar: AppBarReusable(
              ...
              leading: IconButton(
                ...
                onPressed: () {
                  phase2ShortfallApplDetailsProvider
            ...
            body: SafeArea(
              child: Container(
                ...
                child: phase2ShortfallApplDetailsProvider
                        .clusterApplDetails.isNotEmpty
                                  ...
                                  title: Column(
                                    ...
                                    children: [
                                      ...
                                      buildLabelValueRow("Application No",
                                          "${phase2ShortfallApplDetailsProvider.clusterApplDetails[0].aPPLICATIONID}"),
                                      buildLabelValueRow("Applicant Name",
                                          "${phase2ShortfallApplDetailsProvider.clusterApplDetails[0].lAYOUTOWNERNAME}"),
                                    ],
                                  ),
                                  children: [
                                    buildLabelValueRow("Aadhar No",
                                        "${phase2ShortfallApplDetailsProvider.clusterApplDetails[0].aADHARNUMBER}"),
                                    buildLabelValueRow("Owner Mobile Number",
                                        "${phase2ShortfallApplDetailsProvider.clusterApplDetails[0].oWNERMOBILENUMBER}"),
                                    buildLabelValueRow("Address",
                                        "${phase2ShortfallApplDetailsProvider.clusterApplDetails[0].aPPLICANTADDRESS}"),
                                    buildLabelValueRow("District Name",
                                        "${phase2ShortfallApplDetailsProvider.clusterApplDetails[0].dISTRICTNAME}"),
                                    buildLabelValueRow("Pincode",
                                        "${phase2ShortfallApplDetailsProvider.clusterApplDetails[0].pINCODE}"),
                                    BuildDocumentView(
                                    ...
                                    BuildDocumentView(
                                        ...
                                        pdfUrl:
                                            phase2ShortfallApplDetailsProvider
                                                    ...
                                                    .oTHERSDOC ??
                                                ""),
                                    if ((phase2ShortfallApplDetailsProvider
                                                    .clusterApplDetails[0]
                                                    .sLAYOUTDOC !=
                                                null &&
                                            phase2ShortfallApplDetailsProvider
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: DropdownReusable<
                                                ...
                                                items: phase2ShortfallApplDetailsProvider
                                                    .listMasterPlansZDP
                                                    .map<
                                                        DropdownMenuItem<
                                                            ListMasterPlansZDP>>(
          ...
          if (phase2ShortfallApplDetailsProvider.getLoaderVisibilityStatus ||
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      if (!mounted) return;
      await phase2ShortfallApplDetailsProvider
          .getListOfMasterPlansZDPDetails(context);
      if (!mounted) return;
      await phase2ShortfallApplDetailsProvider.getClusterApplDetails(context);
      if (phase2ShortfallApplDetailsProvider.clusterApplDetails.isNotEmpty) {
        ...
        await LocalStoreHelper().writeData(
            ...
            phase2ShortfallApplDetailsProvider
                ...
                "");
        layoutNameController.text = phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].lAYOUTNAME ??
            "";
        layoutOwnerController.text = phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].lAYOUTOWNERNAME ??
            "";
        plotNoController.text =
            phase2ShortfallApplDetailsProvider.clusterApplDetails[0].pLOTNO ??
                "";
        netPlotAreaExtentController.text = phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].aREAEXTENT ??
            "";
        plotAreaExtentController.text = (phase2ShortfallApplDetailsProvider
        ...
        roadEffectedAreaExtentController.text =
            phase2ShortfallApplDetailsProvider
                ...
                "";
        villageNameController.text = phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].vILLAGENAME ??
            "";
        localityController.text =
            phase2ShortfallApplDetailsProvider.clusterApplDetails[0].lOCALITY ??
                "";
        surveyNoController.text = phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].sURVEYNUMBER ??
            "";
        l1RemarksController.text = phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].l1Remarks ??
            "";
        l2RemarksController.text = phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].l2Remarks ??
            "";
        l3RemarksController.text = phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].l3Remarks ??
            "";
        final zdp = phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].mASTERPLANZDP ??
            "";
        if (zdp.isNotEmpty) {
          phase2ShortfallApplDetailsProvider.selectedListMasterPlansZDP =
              phase2ShortfallApplDetailsProvider.listMasterPlansZDP.firstWhere(
            (element) {
              return (element.landUseId == zdp ||
                  element.landUseName?.toLowerCase() == zdp.toLowerCase());
            },
            orElse: () =>
                phase2ShortfallApplDetailsProvider.listMasterPlansZDP[0],
          );
        }
        var officersCommentsList = phase2ShortfallApplDetailsProvider
        ...
        /* officerApprovalController.text =
            (phase2ShortfallApplDetailsProvider.clusterApplDetails[0].officersComments ??
                        [])
                    .isNotEmpty
                ? (phase2ShortfallApplDetailsProvider.clusterApplDetails[0]
                        .officersComments?[0].aPPROVALFLAG ??
                    "")
                : "";
        creartedByController.text =
            (phase2ShortfallApplDetailsProvider.clusterApplDetails[0].officersComments ??
                        [])
                    .isNotEmpty
                ? (phase2ShortfallApplDetailsProvider
        ...
        final checkListStr = (phase2ShortfallApplDetailsProvider
                ...
                (phase2ShortfallApplDetailsProvider
                        ...
                        0) !=
                    0)
            ? jsonEncode(phase2ShortfallApplDetailsProvider
                .clusterApplDetails[0].listSaveDatas)
            : [];
        prefs.setString(
        ...
        prefs.setString(
            ...
            phase2ShortfallApplDetailsProvider.clusterApplDetails[0].eCDOC ??
                "");
        prefs.setString(
        ...
        prefs.setString(
            ...
            phase2ShortfallApplDetailsProvider.clusterApplDetails[0].pHOTO1 ??
                "");
        prefs.setString(
            SharedPrefConstants.plot2Img,
            phase2ShortfallApplDetailsProvider.clusterApplDetails[0].pHOTO2 ??
                "");
        prefs.setString(
            SharedPrefConstants.plot3Img,
            phase2ShortfallApplDetailsProvider.clusterApplDetails[0].pHOTO3 ??
                "");
        prefs.setString(
            SharedPrefConstants.plot4ImgMasterPlanExt,
            phase2ShortfallApplDetailsProvider.clusterApplDetails[0].pHOTO4 ??
                "");
