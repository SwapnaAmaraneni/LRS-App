...
class Phase2ShortfallAddCoordinates extends StatefulWidget {
  const Phase2ShortfallAddCoordinates({super.key});

  @override
  State<Phase2ShortfallAddCoordinates> createState() =>
      _Phase2ShortfallAddCoordinatesState();
}

class _Phase2ShortfallAddCoordinatesState
    extends State<Phase2ShortfallAddCoordinates> {
  @override
  Widget build(BuildContext context) {
    final addCoordinatesProvider =
        Provider.of<Phase2ShortfallAddCoordinatesViewModel>(context);
        ...
        Scaffold(
          appBar: AppBarReusable(
            title: AppConstants.isLayoutPlot == "L"
                ? "Phase-2 Shortfall Layout Coordinates"
                : "Phase-2 Shortfall Plot Coordinates",
          ),
          body: SafeArea(
            child: Stack(
