...
class Phase2ShortfallClusterWiseApplicationList extends StatefulWidget {
  const Phase2ShortfallClusterWiseApplicationList({super.key});

  @override
  State<Phase2ShortfallClusterWiseApplicationList> createState() =>
      _Phase2ShortfallClusterWiseApplicationListState();
}

class _Phase2ShortfallClusterWiseApplicationListState
    extends State<Phase2ShortfallClusterWiseApplicationList> {
  @override
  Widget build(BuildContext context) {
    final clusterwiseApplListProvider =
        Provider.of<Phase2ShortfallClusterWiseApplicationListViewModel>(
            context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-2 Shortfall Clusterwise Applications",
          ),
          body: Stack(
