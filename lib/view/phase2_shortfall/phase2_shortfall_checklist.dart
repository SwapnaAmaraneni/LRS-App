...
class Phase2ShortfallChecklist extends StatefulWidget {
  const Phase2ShortfallChecklist({super.key});

  @override
  State<Phase2ShortfallChecklist> createState() =>
      _Phase2ShortfallChecklistState();
}

class _Phase2ShortfallChecklistState extends State<Phase2ShortfallChecklist> {
  ...
  Widget build(BuildContext context) {
    final checkDetailsProvider =
        Provider.of<Phase2ShortfallCheckDetailsViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-2 Shortfall Check Details",
          ),
          body: Stack(
            children: [
              Container(
