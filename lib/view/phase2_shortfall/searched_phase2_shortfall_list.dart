...
class SearchPhase2ShortfallApplicationList extends StatefulWidget {
  const SearchPhase2ShortfallApplicationList({super.key});

  @override
  State<SearchPhase2ShortfallApplicationList> createState() =>
      _SearchPhase2ShortfallApplicationListState();
}

class _SearchPhase2ShortfallApplicationListState
    extends State<SearchPhase2ShortfallApplicationList> {
  @override
  Widget build(BuildContext context) {
    final searchApplListProvider =
        Provider.of<Phase2ShortfallSearchViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-2 Shortfall Applications",
          ),
          body: Stack(
