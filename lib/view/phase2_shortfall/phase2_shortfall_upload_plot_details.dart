...
class Phase2ShortfallUploadPlotDetails extends StatefulWidget {
  const Phase2ShortfallUploadPlotDetails({super.key});

  @override
  State<Phase2ShortfallUploadPlotDetails> createState() =>
      _Phase2ShortfallUploadPlotDetailsState();
}

class _Phase2ShortfallUploadPlotDetailsState
    extends State<Phase2ShortfallUploadPlotDetails> {
  List gridsData = [
    "plotImg1".tr(),
    "plotImg2".tr(),
    "plotImg3".tr(),
      ...
      children: [
        Scaffold(
          appBar: AppBarReusable(
            title: "Phase-2 Shortfall Plot Details Upload",
            leading: IconButton(
                onPressed: () {
