...
class IndividualPlotSurveynumberWiseCluters extends StatefulWidget {
  const IndividualPlotSurveynumberWiseCluters({super.key});

  @override
  State<IndividualPlotSurveynumberWiseCluters> createState() =>
      _IndividualPlotSurveynumberWiseClutersState();
}

class _IndividualPlotSurveynumberWiseClutersState
    extends State<IndividualPlotSurveynumberWiseCluters> {
  @override
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(
                                          context,
                                          AppRoutes
                                              .individualPlotClusterwiseApplications,
