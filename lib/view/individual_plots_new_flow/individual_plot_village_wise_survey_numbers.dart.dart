...
class IndividualPlotVillageWiseSurveyNumber extends StatefulWidget {
  const IndividualPlotVillageWiseSurveyNumber({super.key});

  @override
  State<IndividualPlotVillageWiseSurveyNumber> createState() =>
      _IndividualPlotVillageWiseSurveyNumberState();
}

class _IndividualPlotVillageWiseSurveyNumberState
    extends State<IndividualPlotVillageWiseSurveyNumber> {
  @override
  Widget build(BuildContext context) {
    final clusterwiseVillageCountProvider =
    ...
    return Stack(
      children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: clusterwiseVillageCountProvider
                                .applications.isNotEmpty
                            ? ListView.builder(
                                itemBuilder: (context, index) {
                                  VillageWiseSurveyNumbers applicationsData =
                                      clusterwiseVillageCountProvider
                                          .applications[index];
                                  return GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(
                                          context,
                                          AppRoutes
                                              .individualPlotSurveynumberWiseCluters,
                                          arguments:
                                ...
                                itemCount: clusterwiseVillageCountProvider
                                    .applications.length,
                              )
                            : Container(),
                      )
        ...
        if (clusterwiseVillageCountProvider.getLoaderVisibilityStatus ||
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final clusterwiseVillageCountProvider =
          Provider.of<VillageWiseSurveyNumbersListViewModel>(context,
              listen: false);
      await clusterwiseVillageCountProvider
          .getVillagewiseApplicationsCount(context);
    });
  }
}
