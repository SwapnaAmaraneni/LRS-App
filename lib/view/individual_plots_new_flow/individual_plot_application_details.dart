...
class IndividualPlotApplicationDetails extends StatefulWidget {
  const IndividualPlotApplicationDetails({super.key});

  @override
  State<IndividualPlotApplicationDetails> createState() =>
      _IndividualPlotApplicationDetailsState();
}

class _IndividualPlotApplicationDetailsState
    extends State<IndividualPlotApplicationDetails> {
  ...
  Widget build(BuildContext context) {
    final clusterwiseApplDetailsProvider =
        Provider.of<IndividualPlotApplicationDetailsViewModel>(context);
