...
class IndividualPlotClusterwiseApplications extends StatefulWidget {
  const IndividualPlotClusterwiseApplications({super.key});

  @override
  State<IndividualPlotClusterwiseApplications> createState() =>
      _IndividualPlotClusterwiseApplicationsState();
}

class _IndividualPlotClusterwiseApplicationsState
    extends State<IndividualPlotClusterwiseApplications> {
  @override
  Widget build(BuildContext context) {
    final clusterwiseApplListProvider =
        Provider.of<ClusterWiseApplicationListViewModel>(context);
    return Stack(
      children: [
        Scaffold(
                            ...
                            return GestureDetector(
                              onTap: () async {
                                LocalStoreHelper sharedpref =
                                    LocalStoreHelper();
                                String? savedApplNo = await LocalStoreHelper()
                                    .readTheData(
                                        SharedPrefConstants.applicationNo);

                                if (savedApplNo != null && savedApplNo.isNotEmpty && savedApplNo != data.aPPLICATIONID) {
                                  WarningCustomCupertinoAlertTwoButtons()
                                      .showAlert(
                                    context,
                                    message:
                                        "Data of the Saved Application ID : $savedApplNo will be lost. Please submit the current application first.",
                                    onPressedOk: () {
                                  ...
                                  print(
                                      "AppConstants.isLayoutPlot::::::::::::::::::::::${AppConstants.isLayoutPlot}");
