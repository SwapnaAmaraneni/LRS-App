...
class SearchClusterwiseApplicationList extends StatefulWidget {
  const SearchClusterwiseApplicationList({super.key});

  @override
  State<SearchClusterwiseApplicationList> createState() =>
      _SearchClusterwiseApplicationListState();
}

class _SearchClusterwiseApplicationListState
    extends State<SearchClusterwiseApplicationList> {
  @override
  Widget build(BuildContext context) {
    final searchApplListProvider = Provider.of<SearchViewModel>(context);
    return Stack(
      children: [
        Scaffold(
