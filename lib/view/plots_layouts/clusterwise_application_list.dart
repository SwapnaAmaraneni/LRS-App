...
class ClusterWiseApplicationList extends StatefulWidget {
  const ClusterWiseApplicationList({super.key});

  @override
  State<ClusterWiseApplicationList> createState() =>
      _ClusterWiseApplicationListState();
}

class _ClusterWiseApplicationListState
    extends State<ClusterWiseApplicationList> {
  @override
