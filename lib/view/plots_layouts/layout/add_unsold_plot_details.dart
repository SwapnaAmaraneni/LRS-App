...
class AddUnsoldPlotDetails extends StatefulWidget {
  const AddUnsoldPlotDetails({super.key});

  @override
  State<AddUnsoldPlotDetails> createState() => _AddUnsoldPlotDetailsState();
}

class _AddUnsoldPlotDetailsState extends State<AddUnsoldPlotDetails> {
  @override
  void initState() {
    super.initState();
