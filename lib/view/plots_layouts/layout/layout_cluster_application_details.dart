...
class LayoutClusterApplicationDetails extends StatefulWidget {
  const LayoutClusterApplicationDetails({super.key});

  @override
  State<LayoutClusterApplicationDetails> createState() =>
      _LayoutClusterApplicationDetailsState();
}

class _LayoutClusterApplicationDetailsState
    extends State<LayoutClusterApplicationDetails> {
    ...
    return PopScope(
      ...
      child: Stack(
        children: [
          Scaffold(
            ...
            body: SafeArea(
              child: Container(
                ...
                child: layoutClusterwiseApplDetailsProvider
                        .clusterApplDetails.isNotEmpty
                                  ...
                                  title: Column(
                                    ...
                                    children: [
                                      ...
                                      buildLabelValueRow("Application No",
                                          "${layoutClusterwiseApplDetailsProvider.clusterApplDetails[0].aPPLICATIONID}"),
                                      buildLabelValueRow("Applicant Name",
                                          "${layoutClusterwiseApplDetailsProvider.clusterApplDetails[0].lAYOUTOWNERNAME}"),
                                    ],
                                  ),
                                  children: [
                                    buildLabelValueRow("Aadhar No",
                                        "${layoutClusterwiseApplDetailsProvider.clusterApplDetails[0].aADHARNUMBER}"),
                                    buildLabelValueRow("Owner Mobile Number",
                                        "${layoutClusterwiseApplDetailsProvider.clusterApplDetails[0].oWNERMOBILENUMBER}"),
                                    buildLabelValueRow("Address",
                                        "${layoutClusterwiseApplDetailsProvider.clusterApplDetails[0].aPPLICANTADDRESS}"),
                                    buildLabelValueRow("District Name",
                                        "${layoutClusterwiseApplDetailsProvider.clusterApplDetails[0].dISTRICTNAME}"),
                                    buildLabelValueRow("Pincode",
                                        "${layoutClusterwiseApplDetailsProvider.clusterApplDetails[0].pINCODE}"),
                                    BuildDocumentView(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: DropdownReusable<
                                                ...
                                                items: layoutClusterwiseApplDetailsProvider
                                                    .listMasterPlansZDP
                                                    .map<
                                                        DropdownMenuItem<
                                                            ListMasterPlansZDP>>(
                              ...
                              child: ReusableButton(
                                ...
                                onPressed: () async {
                                  ...
                                  layoutClusterwiseApplDetailsProvider
                                    ...
                                    /*   plotNo: layoutClusterwiseApplDetailsProvider
          ...
          if (layoutClusterwiseApplDetailsProvider.getLoaderVisibilityStatus ||
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final layoutClusterwiseApplDetailsProvider =
          Provider.of<LayoutClusterApplicationDetailsViewModel>(context,
              listen: false);
      /* layoutClusterwiseApplDetailsProvider.soldPlotsController.clear();
      layoutClusterwiseApplDetailsProvider.unsoldPlotsController.clear();
      layoutClusterwiseApplDetailsProvider.totalNoOfPlotsController.clear();
      layoutClusterwiseApplDetailsProvider.selectedUnsoldPlotDetails = null;
      layoutClusterwiseApplDetailsProvider.totalUnsoldPlotAreaController
          .clear(); */
      if (!mounted) return;
      await layoutClusterwiseApplDetailsProvider
          .getListOfMasterPlansZDPDetails(context);
      if (!mounted) return;
      await layoutClusterwiseApplDetailsProvider.getClusterApplDetails(context);
      if (layoutClusterwiseApplDetailsProvider.clusterApplDetails.isNotEmpty) {
        ...
        if (layoutClusterwiseApplDetailsProvider
          ...
          layoutClusterwiseApplDetailsProvider.layoutNameController.text =
              layoutClusterwiseApplDetailsProvider
                      .clusterApplDetails[0].lAYOUTNAME ??
                  "";
        }
        if (layoutClusterwiseApplDetailsProvider
            .layoutOwnerController.text.isEmpty) {
          layoutClusterwiseApplDetailsProvider.layoutOwnerController.text =
              layoutClusterwiseApplDetailsProvider
        ...
        if (layoutClusterwiseApplDetailsProvider
          ...
          layoutClusterwiseApplDetailsProvider.villageNameController.text =
              layoutClusterwiseApplDetailsProvider
        ...
        if (layoutClusterwiseApplDetailsProvider
          ...
          layoutClusterwiseApplDetailsProvider.localityController.text =
              layoutClusterwiseApplDetailsProvider
                      .clusterApplDetails[0].lOCALITY ??
                  "";
        }
        if (layoutClusterwiseApplDetailsProvider
            .surveyNoController.text.isEmpty) {
          layoutClusterwiseApplDetailsProvider.surveyNoController.text =
              layoutClusterwiseApplDetailsProvider
                      .clusterApplDetails[0].sURVEYNUMBER ??
                  "";
        }
        print(
            "layoutClusterwiseApplDetailsProvider.selectedListMasterPlansZDP.landUseId-------${layoutClusterwiseApplDetailsProvider.selectedListMasterPlansZDP?.landUseId}-------- ${layoutClusterwiseApplDetailsProvider.selectedListMasterPlansZDP?.landUseName}");
        if (layoutClusterwiseApplDetailsProvider.selectedListMasterPlansZDP ==
                null ||
            layoutClusterwiseApplDetailsProvider
            ...
            (layoutClusterwiseApplDetailsProvider
                ...
                true)) {
          print("entered------ ");
          layoutClusterwiseApplDetailsProvider.selectedListMasterPlansZDP =
              layoutClusterwiseApplDetailsProvider.listMasterPlansZDP
                  .firstWhere(
            (element) {
            ...
            orElse: () =>
                layoutClusterwiseApplDetailsProvider.listMasterPlansZDP[0],
          );
        }
        var officersCommentsList = layoutClusterwiseApplDetailsProvider
                .clusterApplDetails[0].officersComments ??
            [];

        if (layoutClusterwiseApplDetailsProvider
            .officerApprovalControllers.isEmpty) {
          for (var comment in officersCommentsList) {
            // Create a controller for each field in officersCommentsList
            layoutClusterwiseApplDetailsProvider.officerApprovalControllers
                .add(TextEditingController(text: comment.aPPROVALFLAG ?? ""));
            layoutClusterwiseApplDetailsProvider.createdByControllers
                .add(TextEditingController(text: comment.cREATEDBY ?? ""));
            layoutClusterwiseApplDetailsProvider.notesAddedControllers
                .add(TextEditingController(text: comment.aDDNOTES ?? ""));
          }
        }
        /*  officerApprovalController.text = (layoutClusterwiseApplDetailsProvider
                        .clusterApplDetails[0].officersComments ??
                    [])
                .isNotEmpty
            ? (layoutClusterwiseApplDetailsProvider
                ...
                "")
            : "";
        creartedByController.text = (layoutClusterwiseApplDetailsProvider
                        .clusterApplDetails[0].officersComments ??
                    [])
                .isNotEmpty
            ? (layoutClusterwiseApplDetailsProvider
                ...
                "")
            : "";
        notesAddedController.text = (layoutClusterwiseApplDetailsProvider
                        .clusterApplDetails[0].officersComments ??
                    [])
                .isNotEmpty
            ? (layoutClusterwiseApplDetailsProvider
...
// Clearing values for Upload Details
    ...
    layoutClusterwiseApplDetailsProvider.totalNoOfPlotsController.clear();
    layoutClusterwiseApplDetailsProvider.selectedUnsoldPlotDetails = null;
    layoutClusterwiseApplDetailsProvider.totalUnsoldPlotAreaController.clear();
  }
}
