...
import '../../res/reusable_widgets/image_picker_component.dart';

class UploadPlotDetails extends StatefulWidget {
  const UploadPlotDetails({super.key});

  @override
  State<UploadPlotDetails> createState() => _UploadPlotDetailsState();
}

class _UploadPlotDetailsState extends State<UploadPlotDetails> {
  List gridsData = [
    "plotImg1".tr(),
    "plotImg2".tr(),
    "plotImg3".tr(),
