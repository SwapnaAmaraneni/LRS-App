...
class _RecommendationsViewState extends State<RecommendationsView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      if (recommendationsProvider.recommendationListMasterPlans.isEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    final recommendationsProvider =
        Provider.of<RecommendationsViewModel>(context);
    return Stack(
      children: [
        Scaffold(
                        ...
                        child: Center(
                          child: ReusableButton(
                            ...
                            onPressed: () {
                              ...
                              if (AppConstants.isBulkUpdate == "y" &&
                                  AppConstants.userType.toLowerCase() != "tp") {
                                recommendationsProvider.bulkUpdateRecords(
                                    context,
                                    recommendationsProvider
                                        .remarksController.text);
                              } else {
