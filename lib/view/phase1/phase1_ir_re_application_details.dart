...
class Phase1IrReApplicationDetails extends StatefulWidget {
  const Phase1IrReApplicationDetails({super.key});

  @override
  State<Phase1IrReApplicationDetails> createState() =>
      _Phase1IrReApplicationDetailsState();
}

class _Phase1IrReApplicationDetailsState
    extends State<Phase1IrReApplicationDetails> {
                                                          ...
                                                          children: [
                                                            ...
                                                            BuildDocumentView(
                                                                ...
                                                                pdfUrl: clusterwiseApplDetailsProvider
                                                                        ...
                                                                        .oTHERSDOC ??
                                                                    ""),
                                                            /*    if ((clusterwiseApplDetailsProvider.clusterApplDetails[0].Phase1Doc1 != null && clusterwiseApplDetailsProvider.clusterApplDetails[0].Phase1Doc1 != "") ||
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      if (locEnabled) {
        ...
        if (clusterwiseApplDetailsProvider.clusterApplDetails.isNotEmpty) {
          ...
          final checkListStr =
              (clusterwiseApplDetailsProvider.clusterApplDetails[0].checkList !=
                          null &&
                      (clusterwiseApplDetailsProvider
