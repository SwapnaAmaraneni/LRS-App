...
import 'package:lrsofficer/view/phase1/phase1_search_applicant.dart';
...
class Phase1SurveyNowiseList extends StatefulWidget {
  const Phase1SurveyNowiseList({super.key});

  @override
  State<Phase1SurveyNowiseList> createState() => _Phase1SurveyNowiseListState();
}

class _Phase1SurveyNowiseListState extends State<Phase1SurveyNowiseList> {
  @override
  Widget build(BuildContext context) {
    final phase1SurveyNowiseListProvider =
        Provider.of<Phase1SurveyNowiseListViewModel>(context);
    final searchProvider = Provider.of<Phase1SearchViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-1 Survey number wise clusters",
          ),
          body: Stack(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: phase1SurveyNowiseListProvider
                                .clusterListCountApplications.isNotEmpty
                            ? ListView.builder(
                                itemBuilder: (context, index) {
                                  final data = phase1SurveyNowiseListProvider
                                      .clusterListCountApplications[index];
                                  return GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(context,
                                          AppRoutes.phase1ClusterWiseList,
                                ...
                                itemCount: phase1SurveyNowiseListProvider
        ...
        if (phase1SurveyNowiseListProvider.getLoaderVisibilityStatus ||
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final phase1SurveyNowiseListProvider =
          Provider.of<Phase1SurveyNowiseListViewModel>(context, listen: false);
      String villageID = ModalRoute.of(context)?.settings.arguments as String;
      await phase1SurveyNowiseListProvider.getClusterListCount(
          context, villageID);
    });
  }
}
