...
class Phase1ApplicationDetails extends StatefulWidget {
  const Phase1ApplicationDetails({super.key});

  @override
  State<Phase1ApplicationDetails> createState() =>
      _Phase1ApplicationDetailsState();
}

class _Phase1ApplicationDetailsState extends State<Phase1ApplicationDetails> {
  ...
  Widget build(BuildContext context) {
    final phase1ApplDetailsProvider =
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (!didPop) {
          phase1ApplDetailsProvider.clusterApplDetails.isNotEmpty
              ? WarningCustomCupertinoAlertTwoButtons().showAlert(
                  context,
                  message:
                      "Data of the Application ID : ${phase1ApplDetailsProvider.clusterApplDetails[0].aPPLICATIONID} will be lost. Do you want to continue? ",
                  onPressedOk: () {
        ...
        children: [
          Scaffold(
            appBar: AppBarReusable(
              title: "Phase-1 Application Details",
              leading: IconButton(
            ...
            body: SafeArea(
              child: Container(
                ...
                child: phase1ApplDetailsProvider.clusterApplDetails.isNotEmpty
                                  ...
                                  title: Column(
                                    ...
                                    children: [
                                      ...
                                      buildLabelValueRow("Application No",
                                          "${phase1ApplDetailsProvider.clusterApplDetails[0].aPPLICATIONID}"),
                                      buildLabelValueRow("Applicant Name",
                                          "${phase1ApplDetailsProvider.clusterApplDetails[0].lAYOUTOWNERNAME}"),
                                    ],
                                  ),
                                  children: [
                                    buildLabelValueRow("Aadhar No",
                                        "${phase1ApplDetailsProvider.clusterApplDetails[0].aADHARNUMBER}"),
                                    buildLabelValueRow("Owner Mobile Number",
                                        "${phase1ApplDetailsProvider.clusterApplDetails[0].oWNERMOBILENUMBER}"),
                                    buildLabelValueRow("Address",
                                        "${phase1ApplDetailsProvider.clusterApplDetails[0].aPPLICANTADDRESS}"),
                                    buildLabelValueRow("District Name",
                                        "${phase1ApplDetailsProvider.clusterApplDetails[0].dISTRICTNAME}"),
                                    buildLabelValueRow("Pincode",
                                        "${phase1ApplDetailsProvider.clusterApplDetails[0].pINCODE}"),
                                    BuildDocumentView(
                                        title: "Sales Deed Document",
                                        pdfUrl: phase1ApplDetailsProvider
                                    ...
                                    BuildDocumentView(
                                        ...
                                        pdfUrl: phase1ApplDetailsProvider
                                                ...
                                                .oTHERSDOC ??
                                            ""),
                                    if ((phase1ApplDetailsProvider
                                                    .clusterApplDetails[0]
                                                    .prohibitedDoc1 !=
                                                null &&
                                            phase1ApplDetailsProvider
                                                    .clusterApplDetails[0]
                                                    .prohibitedDoc1 !=
                                                "") ||
                                        (phase1ApplDetailsProvider
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: DropdownReusable<
                                                ...
                                                items: phase1ApplDetailsProvider
                                                    .listMasterPlansZDP
                                                    .map<
                                                        DropdownMenuItem<
                                                            ListMasterPlansZDP>>(
                                    ...
                                    if (phase1ApplDetailsProvider
                                      ...
                                      Padding(
                                        ...
                                        child: DocumentDownload(
                                          sroEditFlag: phase1ApplDetailsProvider
                                                  .clusterApplDetails[0]
                                                  .sroCodeEdit ??
                                              "",
                              ...
                              child: ReusableButton(
                                ...
                                onPressed: () async {
                                  ...
                                  phase1ApplDetailsProvider
                                    ...
                                    context,
                                    applicationId: phase1ApplDetailsProvider
                                            .clusterApplDetails[0]
                                            .aPPLICATIONID ??
                                        "",
                                    layoutName: phase1ApplDetailsProvider
                                    ...
                                    roadAreaExtent:
                                        roadEffectedAreaExtentController.text
                                            .trim(),
                                    masterplanZdp: phase1ApplDetailsProvider
                                            .selectedListMasterPlansZDP
                                            ?.landUseName ??
                                        "",
                                    sroCode: sroCode,
          ...
          if (phase1ApplDetailsProvider.getLoaderVisibilityStatus ||
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      if (!mounted) return;
      await phase1ApplDetailsProvider.getListOfMasterPlansZDPDetails(context);
      if (!mounted) return;
      await phase1ApplDetailsProvider.getClusterApplDetails(context);
      if (phase1ApplDetailsProvider.clusterApplDetails.isNotEmpty) {
        await LocalStoreHelper().writeData(
            SharedPrefConstants.sroCode,
            phase1ApplDetailsProvider.clusterApplDetails[0].sROCODEFOURDIGITS ??
                "");
        await LocalStoreHelper().writeData(
            SharedPrefConstants.saleDeedNo,
            phase1ApplDetailsProvider.clusterApplDetails[0].sALEDEEDNUMBER ??
                "");

        await LocalStoreHelper().writeData(SharedPrefConstants.saleDeedYear,
            phase1ApplDetailsProvider.clusterApplDetails[0].sALEDEEDYEAR ?? "");
        layoutNameController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].lAYOUTNAME ?? "";
        layoutOwnerController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].lAYOUTOWNERNAME ??
                "";
        plotNoController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].pLOTNO ?? "";
        netPlotAreaExtentController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].aREAEXTENT ?? "";
        plotAreaExtentController.text = (phase1ApplDetailsProvider
                        .clusterApplDetails[0].pLOTAREAEXTENT ??
                    "".trim())
                .isEmpty
            ? phase1ApplDetailsProvider.clusterApplDetails[0].aREAEXTENT ?? ""
            : phase1ApplDetailsProvider.clusterApplDetails[0].pLOTAREAEXTENT ??
                "";
        roadEffectedAreaExtentController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].rOADAREAEXTENT ??
                "";
        villageNameController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].vILLAGENAME ?? "";
        localityController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].lOCALITY ?? "";
        surveyNoController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].sURVEYNUMBER ?? "";
        l1RemarksController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].l1Remarks ?? "";
        l2RemarksController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].l2Remarks ?? "";
        l3RemarksController.text =
            phase1ApplDetailsProvider.clusterApplDetails[0].l3Remarks ?? "";
        final zdp =
            phase1ApplDetailsProvider.clusterApplDetails[0].mASTERPLANZDP ?? "";
        if (zdp.isNotEmpty) {
          phase1ApplDetailsProvider.selectedListMasterPlansZDP =
              phase1ApplDetailsProvider.listMasterPlansZDP.firstWhere(
            (element) {
              return (element.landUseId == zdp ||
                  element.landUseName?.toLowerCase() == zdp.toLowerCase());
            },
            orElse: () => phase1ApplDetailsProvider.listMasterPlansZDP[0],
          );
        }
        var officersCommentsList =
            phase1ApplDetailsProvider.clusterApplDetails[0].officersComments ??
                [];
        ...
        /* officerApprovalController.text =
            (phase1ApplDetailsProvider.clusterApplDetails[0].officersComments ??
                        [])
                    .isNotEmpty
                ? (phase1ApplDetailsProvider.clusterApplDetails[0]
        ...
        await LocalStoreHelper().writeData(
            ...
            phase1ApplDetailsProvider.clusterApplDetails[0].sALEDEEDNUMBER ??
                "");
        await LocalStoreHelper().writeData(SharedPrefConstants.checkListKey,
            phase1ApplDetailsProvider.clusterApplDetails[0].strCHECKLIST ?? "");
        await LocalStoreHelper().writeData(SharedPrefConstants.saleDeedYear,
            phase1ApplDetailsProvider.clusterApplDetails[0].sALEDEEDYEAR ?? "");
      }
    });
