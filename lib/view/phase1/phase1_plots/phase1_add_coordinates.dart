...
class Phase1AddCoordinates extends StatefulWidget {
  const Phase1AddCoordinates({super.key});

  @override
  State<Phase1AddCoordinates> createState() => _Phase1AddCoordinatesState();
}

class _Phase1AddCoordinatesState extends State<Phase1AddCoordinates> {
  @override
  Widget build(BuildContext context) {
    final addCoordinatesProvider =
        Provider.of<Phase1AddCoordinatesViewModel>(context);
  ...
  initState() {
    super.initState();
    final addCoordinatesProvider =
        Provider.of<Phase1AddCoordinatesViewModel>(context, listen: false);
    if (!kReleaseMode) {
      debugPrint(
