...
class Phase1VillagewiseList extends StatefulWidget {
  const Phase1VillagewiseList({super.key});

  @override
  State<Phase1VillagewiseList> createState() => _Phase1VillagewiseListState();
}

class _Phase1VillagewiseListState extends State<Phase1VillagewiseList> {
  @override
  Widget build(BuildContext context) {
    final phase1VillagewiseListProvider =
        Provider.of<Phase1VillagewiseListViewModel>(context);
    final searchProvider = Provider.of<Phase1SearchViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-1 Village wise Survey Numbers",
          ),
          body: Stack(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: phase1VillagewiseListProvider
                                .applications.isNotEmpty
                            ? ListView.builder(
                                itemBuilder: (context, index) {
                                  VillageWiseSurveyNumbers applicationsData =
                                      phase1VillagewiseListProvider
                                          .applications[index];
                                  return GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(context,
                                          AppRoutes.phase1SurveyWiseList,
                                          arguments:
                                ...
                                itemCount: phase1VillagewiseListProvider
                                    .applications.length,
                              )
                            : Container(),
                      )
        ...
        if (phase1VillagewiseListProvider.getLoaderVisibilityStatus ||
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final phase1VillagewiseListProvider =
          Provider.of<Phase1VillagewiseListViewModel>(context, listen: false);
      await phase1VillagewiseListProvider.getClusterWiseVillageCount(context);
    });
  }
}
