...
class Phase1LayoutApplicationDetails extends StatefulWidget {
  const Phase1LayoutApplicationDetails({super.key});

  @override
  State<Phase1LayoutApplicationDetails> createState() =>
      _Phase1LayoutApplicationDetailsState();
}

class _Phase1LayoutApplicationDetailsState
    extends State<Phase1LayoutApplicationDetails> {
  ...
  Widget build(BuildContext context) {
    final phase1LayoutAppDetailsProvider =
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (!didPop) {
          phase1LayoutAppDetailsProvider.clusterApplDetails.isNotEmpty
              ? WarningCustomCupertinoAlertTwoButtons().showAlert(
                  context,
                  message:
                      "Data of the Application ID : ${phase1LayoutAppDetailsProvider.clusterApplDetails[0].aPPLICATIONID} will be lost. Do you want to continue? ",
                  onPressedOk: () {
      ...
      child: Stack(
        children: [
          Scaffold(
            ...
            body: SafeArea(
              child: Container(
                ...
                child: phase1LayoutAppDetailsProvider
                                  ...
                                  title: Column(
                                    ...
                                    children: [
                                      ...
                                      buildLabelValueRow("Application No",
                                          "${phase1LayoutAppDetailsProvider.clusterApplDetails[0].aPPLICATIONID}"),
                                      buildLabelValueRow("Applicant Name",
                                          "${phase1LayoutAppDetailsProvider.clusterApplDetails[0].lAYOUTOWNERNAME}"),
                                    ],
                                  ),
                                  children: [
                                    buildLabelValueRow("Aadhar No",
                                        "${phase1LayoutAppDetailsProvider.clusterApplDetails[0].aADHARNUMBER}"),
                                    buildLabelValueRow("Owner Mobile Number",
                                        "${phase1LayoutAppDetailsProvider.clusterApplDetails[0].oWNERMOBILENUMBER}"),
                                    buildLabelValueRow("Address",
                                        "${phase1LayoutAppDetailsProvider.clusterApplDetails[0].aPPLICANTADDRESS}"),
                                    buildLabelValueRow("District Name",
                                        "${phase1LayoutAppDetailsProvider.clusterApplDetails[0].dISTRICTNAME}"),
                                    buildLabelValueRow("Pincode",
                                        "${phase1LayoutAppDetailsProvider.clusterApplDetails[0].pINCODE}"),
                                    BuildDocumentView(
                                        title: "Sales Deed Document",
                                        pdfUrl: phase1LayoutAppDetailsProvider
                                    ...
                                    BuildDocumentView(
                                        ...
                                        pdfUrl: phase1LayoutAppDetailsProvider
                                                ...
                                                .oTHERSDOC ??
                                            ""),
                                    if ((phase1LayoutAppDetailsProvider
                                                    .clusterApplDetails[0]
                                                    .prohibitedDoc1 !=
                                                null &&
                                            phase1LayoutAppDetailsProvider
                                                    .clusterApplDetails[0]
                                                    .prohibitedDoc1 !=
                                                "") ||
                                        (phase1LayoutAppDetailsProvider
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: DropdownReusable<
                                                ...
                                                items: phase1LayoutAppDetailsProvider
                                                    .listMasterPlansZDP
                                                    .map<
                                                        DropdownMenuItem<
                                                            ListMasterPlansZDP>>(
                              ...
                              child: ReusableButton(
                                ...
                                onPressed: () async {
                                  ...
                                  phase1LayoutAppDetailsProvider
                                    ...
                                    /*   plotNo: phase1LayoutAppDetailsProvider
          ...
          if (phase1LayoutAppDetailsProvider.getLoaderVisibilityStatus ||
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final phase1LayoutAppDetailsProvider =
          Provider.of<Phase1LayoutApplicationDetailsViewModel>(context,
              listen: false);
      phase1LayoutAppDetailsProvider.soldPlotsController.clear();
      phase1LayoutAppDetailsProvider.unsoldPlotsController.clear();
      phase1LayoutAppDetailsProvider.totalNoOfPlotsController.clear();
      phase1LayoutAppDetailsProvider.selectedUnsoldPlotDetails = null;
      phase1LayoutAppDetailsProvider.totalUnsoldPlotAreaController.clear();
      if (!mounted) return;
      await phase1LayoutAppDetailsProvider
          .getListOfMasterPlansZDPDetails(context);
      if (!mounted) return;
      await phase1LayoutAppDetailsProvider.getClusterApplDetails(context);
      if (phase1LayoutAppDetailsProvider.clusterApplDetails.isNotEmpty) {
        ...
        await LocalStoreHelper().writeData(
            ...
            phase1LayoutAppDetailsProvider.clusterApplDetails[0].sALEDEEDYEAR ??
                "");
        layoutNameController.text =
            phase1LayoutAppDetailsProvider.clusterApplDetails[0].lAYOUTNAME ??
                "";
        layoutOwnerController.text = phase1LayoutAppDetailsProvider
                .clusterApplDetails[0].lAYOUTOWNERNAME ??
            "";
        villageNameController.text =
            phase1LayoutAppDetailsProvider.clusterApplDetails[0].vILLAGENAME ??
                "";
        localityController.text =
            phase1LayoutAppDetailsProvider.clusterApplDetails[0].lOCALITY ?? "";
        surveyNoController.text =
            phase1LayoutAppDetailsProvider.clusterApplDetails[0].sURVEYNUMBER ??
                "";
        l1RemarksController.text =
            phase1LayoutAppDetailsProvider.clusterApplDetails[0].l1Remarks ??
                "";
        l2RemarksController.text =
            phase1LayoutAppDetailsProvider.clusterApplDetails[0].l2Remarks ??
                "";
        l3RemarksController.text =
            phase1LayoutAppDetailsProvider.clusterApplDetails[0].l3Remarks ??
                "";
        final zdp = phase1LayoutAppDetailsProvider
                .clusterApplDetails[0].mASTERPLANZDP ??
            "";
        if (zdp.isNotEmpty) {
          phase1LayoutAppDetailsProvider.selectedListMasterPlansZDP =
              phase1LayoutAppDetailsProvider.listMasterPlansZDP.firstWhere(
            (element) {
              return (element.landUseId == zdp ||
                  element.landUseName?.toLowerCase() == zdp.toLowerCase());
            },
            orElse: () => phase1LayoutAppDetailsProvider.listMasterPlansZDP[0],
          );
        }
        var officersCommentsList = phase1LayoutAppDetailsProvider
        ...
        /* officerApprovalController.text = (phase1LayoutAppDetailsProvider
                        .clusterApplDetails[0].officersComments ??
                    [])
                .isNotEmpty
            ? (phase1LayoutAppDetailsProvider
                ...
                "")
            : "";
        creartedByController.text = (phase1LayoutAppDetailsProvider
                        .clusterApplDetails[0].officersComments ??
                    [])
                .isNotEmpty
            ? (phase1LayoutAppDetailsProvider
                ...
                "")
            : "";
        notesAddedController.text = (phase1LayoutAppDetailsProvider
                        .clusterApplDetails[0].officersComments ??
                    [])
                .isNotEmpty
            ? (phase1LayoutAppDetailsProvider
