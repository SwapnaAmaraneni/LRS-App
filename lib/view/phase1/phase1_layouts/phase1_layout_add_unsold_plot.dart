...
class Phase1AddUnsoldPlotDetails extends StatefulWidget {
  const Phase1AddUnsoldPlotDetails({super.key});

  @override
  State<Phase1AddUnsoldPlotDetails> createState() =>
      _Phase1AddUnsoldPlotDetailsState();
}

class _Phase1AddUnsoldPlotDetailsState
    extends State<Phase1AddUnsoldPlotDetails> {
  @override
  void initState() {
    super.initState();
    ...
    return PopScope(
        ...
        if (!didPop) {
          WarningCustomCupertinoAlertTwoButtons().showAlert(
            ...
            onPressedOk: () {
              ...
              Navigator.popUntil(
                context,
                ModalRoute.withName(AppRoutes.phase1LayoutApplicationDetails),
              );
            },
            onPressedCancel: () {
      ...
      child: Scaffold(
        appBar: const AppBarReusable(
          title: "Phase-1 Unsold Plots List",
        ),
        body: SafeArea(
          child: Stack(
