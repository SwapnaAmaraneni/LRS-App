...
class Phase1PaymentDetails extends StatefulWidget {
  const Phase1PaymentDetails({super.key});

  @override
  State<Phase1PaymentDetails> createState() => _Phase1PaymentDetailsState();
}

class _Phase1PaymentDetailsState extends State<Phase1PaymentDetails> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final phase1paymentDetailsProvider =
          Provider.of<Phase1PaymentDetailsViewModel>(context, listen: false);
      phase1paymentDetailsProvider.setchargesFlag(false);
  ...
  Widget build(BuildContext context) {
    final phase1paymentDetailsProvider =
        Provider.of<Phase1PaymentDetailsViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: AppBarReusable(
            title: "Phase-1 Payment Details",
            leading: IconButton(
              onPressed: () {
                    ...
                    Card(
                      child: Column(
                        children: [
                              ...
                              Flexible(
                                ...
                                child: Center(
                                  child: ReusableButton(
                                    ...
                                    onPressed: () async {
                                      FocusScope.of(context).unfocus();
                                      if (phase1paymentDetailsProvider
                                          .paymentDetailsValidation(
                                              conversionCharges.text,
                                              mv.text,
                                              mvDateOfRegstn.text,
                                              context)) {
                                        await phase1paymentDetailsProvider
                                            .paymentDetalsCalc(
                                                conversionCharges.text,
                                                mv.text,
                                                mvDateOfRegstn.text,
                                      ...
                                      // Navigator.pushNamed(context, AppRoutes.Phase1paymentDetails);
                                    },
                                  ),
                                ),
                              ),
                              Visibility(
                                visible: !(phase1paymentDetailsProvider
                                        .getchargesFlag ||
                          ...
                          Visibility(
                            visible:
                                phase1paymentDetailsProvider.getchargesFlag,
                            child: Column(
                              children: [
                                const SizedBox(
                                  height: 30,
        ...
        if (phase1paymentDetailsProvider.getLoaderVisibilityStatus)
