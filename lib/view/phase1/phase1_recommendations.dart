...
class Phase1Recommendations extends StatefulWidget {
  const Phase1Recommendations({super.key});

  @override
  State<Phase1Recommendations> createState() => _Phase1RecommendationsState();
}

class _Phase1RecommendationsState extends State<Phase1Recommendations> {
  TextEditingController remarksController = TextEditingController();
  @override
  Widget build(BuildContext context) {
    if (!kReleaseMode) debugPrint("UserType:: ${AppConstants.userType}");
    final recommendationsProvider =
        Provider.of<Phase1RecommendationsModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-1 Recommendations",
          ),
          body: SafeArea(
            child: Container(
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final recommendationsProvider =
          Provider.of<Phase1RecommendationsModel>(context, listen: false);
