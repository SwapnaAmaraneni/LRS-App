...
class Phase1ClusterWiseApplicationList extends StatefulWidget {
  const Phase1ClusterWiseApplicationList({super.key});

  @override
  State<Phase1ClusterWiseApplicationList> createState() =>
      _Phase1ClusterWiseApplicationListState();
}

class _Phase1ClusterWiseApplicationListState
    extends State<Phase1ClusterWiseApplicationList> {
  @override
  Widget build(BuildContext context) {
    final clusterwiseApplListProvider =
        Provider.of<Phase1ClusterWiseApplicationListViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-1 Clusterwise Applications",
          ),
          body: Stack(
