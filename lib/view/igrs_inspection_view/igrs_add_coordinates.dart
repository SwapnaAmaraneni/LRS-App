...
class IGRSAddCoordinates extends StatefulWidget {
  const IGRSAddCoordinates({super.key});

  @override
  State<IGRSAddCoordinates> createState() => _IGRSAddCoordinatesState();
}

class _IGRSAddCoordinatesState extends State<IGRSAddCoordinates> {
  @override
  Widget build(BuildContext context) {
    final addCoordinatesProvider =
        Provider.of<IGRSAddCoordinatesViewModel>(context);
  ...
  initState() {
    super.initState();
    final addCoordinatesProvider =
        Provider.of<IGRSAddCoordinatesViewModel>(context, listen: false);
    if (!kReleaseMode) {
      debugPrint(
