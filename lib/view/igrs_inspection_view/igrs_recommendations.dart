...
class IGRSRecommendations extends StatefulWidget {
  const IGRSRecommendations({super.key});

  @override
  State<IGRSRecommendations> createState() => _IGRSRecommendationsState();
}

class _IGRSRecommendationsState extends State<IGRSRecommendations> {
  TextEditingController remarksController = TextEditingController();
  @override
  Widget build(BuildContext context) {
    if (!kReleaseMode) debugPrint("UserType:: ${AppConstants.userType}");
    final recommendationsProvider =
        Provider.of<IGRSRecommendationsViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "IGRS Recommendations",
          ),
          body: SafeArea(
            child: Container(
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final recommendationsProvider =
          Provider.of<IGRSRecommendationsViewModel>(context, listen: false);
