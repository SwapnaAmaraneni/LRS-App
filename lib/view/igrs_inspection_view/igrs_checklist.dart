...
class IGRSChecklist extends StatefulWidget {
  const IGRSChecklist({super.key});

  @override
  State<IGRSChecklist> createState() => _IGRSChecklistState();
}

class _IGRSChecklistState extends State<IGRSChecklist> {
  List<ListSaveData> checkList = [];
  List<TextEditingController> remarksControllers = [];
  @override
  Widget build(BuildContext context) {
    final checkDetailsProvider = Provider.of<IGRSCheckListViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "IGRS Check Details",
          ),
          body: Stack(
            children: [
              Container(
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final checkDetailsProvider =
          Provider.of<IGRSCheckListViewModel>(context, listen: false);
