...
class SavedCheckDetails extends StatefulWidget {
  const SavedCheckDetails({super.key});

  @override
  State<SavedCheckDetails> createState() => _SavedCheckDetailsState();
}

class _SavedCheckDetailsState extends State<SavedCheckDetails> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      if (checkDetailsProvider.applications.isEmpty && checkDetailsProvider.remarksControllers.isEmpty) {
  ...
  Widget build(BuildContext context) {
    final checkDetailsProvider = Provider.of<CheckDetailsViewModel>(context);
    return Stack(
      children: [
        Scaffold(
