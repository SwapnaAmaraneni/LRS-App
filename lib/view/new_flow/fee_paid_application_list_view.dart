...
class FeePaidApplicationListView extends StatefulWidget {
  const FeePaidApplicationListView({super.key});

  @override
  State<FeePaidApplicationListView> createState() =>
      _FeePaidApplicationListViewState();
}

class _FeePaidApplicationListViewState
    extends State<FeePaidApplicationListView> {
  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<FeePaidApplicationsListViewModel>(context);
    return PopScope(
      canPop: false,
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final provider =
          Provider.of<FeePaidApplicationsListViewModel>(context, listen: false);
