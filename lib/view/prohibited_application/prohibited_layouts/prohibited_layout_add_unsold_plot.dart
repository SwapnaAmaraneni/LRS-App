...
class ProhibitedAddUnsoldPlotDetails extends StatefulWidget {
  const ProhibitedAddUnsoldPlotDetails({super.key});

  @override
  State<ProhibitedAddUnsoldPlotDetails> createState() =>
      _ProhibitedAddUnsoldPlotDetailsState();
}

class _ProhibitedAddUnsoldPlotDetailsState
    extends State<ProhibitedAddUnsoldPlotDetails> {
  @override
  void initState() {
    super.initState();
          ...
          WarningCustomCupertinoAlertTwoButtons().showAlert(
            ...
            onPressedOk: () {
              ...
              Navigator.popUntil(
                context,
                ModalRoute.withName(
                    AppRoutes.prohibitedLayoutApplicationDetails),
              );
            },
            onPressedCancel: () {
