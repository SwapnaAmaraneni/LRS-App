...
class ProhibitedRecommendations extends StatefulWidget {
  const ProhibitedRecommendations({super.key});

  @override
  State<ProhibitedRecommendations> createState() =>
      _ProhibitedRecommendationsState();
}

class _ProhibitedRecommendationsState extends State<ProhibitedRecommendations> {
  @override
  Widget build(BuildContext context) {
    if (!kReleaseMode) debugPrint("UserType:: ${AppConstants.userType}");
    final recommendationsProvider =
        Provider.of<ProhibitedRecommendationsModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Prohibited Recommendations",
          ),
          body: SafeArea(
            child: Container(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            controller: recommendationsProvider.remarksController,
                                  ...
                                  WarningCustomCupertinoAlertTwoButtons()
                                    ...
                                    onPressedOk: () {
                                      ...
                                      recommendationsProvider.finalSaveMethod(
                                          context, recommendationsProvider.remarksController.text);
                                    },
                                    onPressedCancel: () {
                                      Navigator.pop(context);
                                    },
                          ...
                          child: ReusableButton(
                            ...
                            onPressed: () {
                              if (AppConstants.isLayoutPlot == "P") {
                                ...
                                recommendationsProvider.finalLayoutSubmitMethod(
                                    context, recommendationsProvider.remarksController.text);
                              }
                            },
                          ),
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final recommendationsProvider =
          Provider.of<ProhibitedRecommendationsModel>(context, listen: false);
      await recommendationsProvider.getRecommendationsDetails(context);
      
      if (AppConstants.isSavedApplication == "yes" && !recommendationsProvider.isInitialized) {
        ...
        recommendationsProvider.remarksController.text = savedRemarks ?? "";
      }
    });
  }
}
