...
class ProhibitedAddCoordinates extends StatefulWidget {
  const ProhibitedAddCoordinates({super.key});

  @override
  State<ProhibitedAddCoordinates> createState() =>
      _ProhibitedAddCoordinatesState();
}

class _ProhibitedAddCoordinatesState extends State<ProhibitedAddCoordinates> {
  @override
  Widget build(BuildContext context) {
    final addCoordinatesProvider =
        Provider.of<ProhibitedAddCoordinatesViewModel>(context);
        ...
        Scaffold(
          appBar: AppBarReusable(
            title: AppConstants.isLayoutPlot == "L"
                ? "Prohibited Layout Coordinates"
                : "Prohibited Plot Coordinates",
          ),
          body: SafeArea(
            child: Stack(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      if (addCoordinatesProvider.getAddedCoordinates.isNotEmpty)
                        Expanded(
  ...
  initState() {
    super.initState();
    final addCoordinatesProvider =
        Provider.of<ProhibitedAddCoordinatesViewModel>(context, listen: false);
    if (!kReleaseMode) {
      debugPrint(
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (timeStamp) async {
        // Skip if coordinates are already loaded — preserves state on back-navigation
        if (addCoordinatesProvider.getAddedCoordinates.isNotEmpty) return;
