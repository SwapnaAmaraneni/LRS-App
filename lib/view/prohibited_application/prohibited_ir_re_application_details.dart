...
class ProhibitedIrReApplicationDetails extends StatefulWidget {
  const ProhibitedIrReApplicationDetails({super.key});

  @override
  State<ProhibitedIrReApplicationDetails> createState() =>
      _ProhibitedIrReApplicationDetailsState();
}

class _ProhibitedIrReApplicationDetailsState
    extends State<ProhibitedIrReApplicationDetails> {
        ...
        if (clusterwiseApplDetailsProvider.clusterApplDetails.isNotEmpty) {
          ...
          if (zdp.isNotEmpty) {
            clusterwiseApplDetailsProvider.selectedListMasterPlansZDP =
              ...
              (element) {
                return (element.landUseId == zdp || element.landUseName == zdp);
              },
              orElse: () =>
