...
class Phase2RevertedRecommendations extends StatefulWidget {
  const Phase2RevertedRecommendations({super.key});

  @override
  State<Phase2RevertedRecommendations> createState() =>
      _Phase2RevertedRecommendationsState();
}

class _Phase2RevertedRecommendationsState
    extends State<Phase2RevertedRecommendations> {
  TextEditingController remarksController = TextEditingController();
  @override
  Widget build(BuildContext context) {
    if (!kReleaseMode) debugPrint("UserType:: ${AppConstants.userType}");
    final recommendationsProvider =
        Provider.of<Phase2RevertedRecommendationsModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-2 Reverted Recommendations",
          ),
          body: SafeArea(
            child: Container(
