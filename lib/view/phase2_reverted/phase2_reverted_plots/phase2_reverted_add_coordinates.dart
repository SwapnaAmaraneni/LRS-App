...
class Phase2RevertedAddCoordinates extends StatefulWidget {
  const Phase2RevertedAddCoordinates({super.key});

  @override
  State<Phase2RevertedAddCoordinates> createState() =>
      _Phase2RevertedAddCoordinatesState();
}

class _Phase2RevertedAddCoordinatesState
    extends State<Phase2RevertedAddCoordinates> {
  @override
  Widget build(BuildContext context) {
    final addCoordinatesProvider =
        Provider.of<Phase2RevertedAddCoordinatesViewModel>(context);
        ...
        Scaffold(
          appBar: AppBarReusable(
            title: AppConstants.isLayoutPlot == "L"
                ? "Phase-2 Reverted Layout Coordinates"
                : "Phase-2 Reverted Plot Coordinates",
          ),
          body: SafeArea(
            child: Stack(
