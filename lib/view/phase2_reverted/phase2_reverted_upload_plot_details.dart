...
class Phase2RevertedUploadPlotDetails extends StatefulWidget {
  const Phase2RevertedUploadPlotDetails({super.key});

  @override
  State<Phase2RevertedUploadPlotDetails> createState() =>
      _Phase2RevertedUploadPlotDetailsState();
}

class _Phase2RevertedUploadPlotDetailsState
    extends State<Phase2RevertedUploadPlotDetails> {
  List gridsData = [
    "plotImg1".tr(),
    "plotImg2".tr(),
    "plotImg3".tr(),
      ...
      children: [
        Scaffold(
          appBar: AppBarReusable(
            title: "Phase-2 Reverted Plot Details Upload",
            leading: IconButton(
                onPressed: () {
