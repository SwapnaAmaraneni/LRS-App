...
class Phase2RevertedAddUnsoldPlotDetails extends StatefulWidget {
  const Phase2RevertedAddUnsoldPlotDetails({super.key});

  @override
  State<Phase2RevertedAddUnsoldPlotDetails> createState() =>
      _Phase2RevertedAddUnsoldPlotDetailsState();
}

class _Phase2RevertedAddUnsoldPlotDetailsState
    extends State<Phase2RevertedAddUnsoldPlotDetails> {
  int unsoldPlotsCount = 0;
  @override
  void initState() {
    super.initState();
    final phase2RevertedLayoutsProvider =
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (timeStamp) async {
        ...
        phase2RevertedLayoutsProvider.plotDetailsList
            .addAll(finalUnsoldPlotsList);
        setState(() {});
      },
    );
    AppLogger().logDebug(
        "initstate length ::: ${phase2RevertedLayoutsProvider.plotDetailsList.length}");
  }
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: const AppBarReusable(
          title: "Phase-2 Reverted Unsold Plots List",
        ),
        body: SafeArea(
          child: Stack(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    (!(phase2RevertedLayoutsProvider.plotDetailsList.length ==
                                unsoldPlotsCount ||
                            phase2RevertedLayoutsProvider
                        ...
                        ? Card(
                            child: Column(
                              ...
                              children: [
                                ...
                                AppInputTextfield(
                                  hintText: "Plot No",
                                  nameController: phase2RevertedLayoutsProvider
                                      .plotNoController,
                                ),
                                AppInputTextfield(
                    ...
                    unsoldPlotsCount != 0
                        ? Expanded(
                            child: ListView.builder(
                              itemCount: phase2RevertedLayoutsProvider
                                  .plotDetailsList.length,
                              itemBuilder: (context, index) {
                                ...
                                final details = phase2RevertedLayoutsProvider
                    ...
                    Align(
                      ...
                      child: ReusableButton(
                        ...
                        onPressed: () {
                          if (!kReleaseMode) {
                            debugPrint(
                                "length list ::: ${phase2RevertedLayoutsProvider.plotDetailsList.length}");
                          }
                          if (phase2RevertedLayoutsProvider
                                  .plotDetailsList.length ==
                              unsoldPlotsCount) {
