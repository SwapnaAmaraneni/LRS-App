...
class Phase2RevertedClusterWiseApplicationList extends StatefulWidget {
  const Phase2RevertedClusterWiseApplicationList({super.key});

  @override
  State<Phase2RevertedClusterWiseApplicationList> createState() =>
      _Phase2RevertedClusterWiseApplicationListState();
}

class _Phase2RevertedClusterWiseApplicationListState
    extends State<Phase2RevertedClusterWiseApplicationList> {
  @override
  Widget build(BuildContext context) {
    final clusterwiseApplListProvider =
        Provider.of<Phase2RevertedClusterWiseApplicationListViewModel>(
            context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-2 Reverted Clusterwise Applications",
          ),
          body: Stack(
