...
class SearchPhase2RevertedApplicationList extends StatefulWidget {
  const SearchPhase2RevertedApplicationList({super.key});

  @override
  State<SearchPhase2RevertedApplicationList> createState() =>
      _SearchPhase2RevertedApplicationListState();
}

class _SearchPhase2RevertedApplicationListState
    extends State<SearchPhase2RevertedApplicationList> {
  @override
  Widget build(BuildContext context) {
    final searchApplListProvider =
        Provider.of<Phase2RevertedSearchViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-2 Reverted Applications",
          ),
          body: Stack(
