...
class Phase2RevertedChecklist extends StatefulWidget {
  const Phase2RevertedChecklist({super.key});

  @override
  State<Phase2RevertedChecklist> createState() =>
      _Phase2RevertedChecklistState();
}

class _Phase2RevertedChecklistState extends State<Phase2RevertedChecklist> {
  ...
  Widget build(BuildContext context) {
    final checkDetailsProvider =
        Provider.of<Phase2RevertedCheckDetailsViewModel>(context);
    return Stack(
      children: [
        Scaffold(
          appBar: const AppBarReusable(
            title: "Phase-2 Reverted Check Details",
          ),
          body: Stack(
            children: [
              Container(
