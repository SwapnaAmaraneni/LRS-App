...
class ProhibitedApplDetailsRepository {
  final _baseClient = BaseApiClient();
  Future<ClusterApplicationDetailsResponse?> prohibitedApplDetailsRepo(
  ...
  Future<ClusterwiseApplicationListResponse?> prohibitedApplListRepo(
